...
(function() {
  var $window, Button, Channel, ChannelCollection, ChannelListItem, Collection, ListItem, ListView, MessageListItem, Model, NewMessageForm, ONE_WEEK, StringInput, View, activateChannel, active_channel, active_channel_messages, channel_collection, renderAttachmentContent, setUpInterface, withinRange, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
  ...
  MessageListItem = (function(_super) {
    ...
    MessageListItem.prototype.render = function() {
      ...
      if (this.model.get('attachments_url')) {
