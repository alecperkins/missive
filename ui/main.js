...
(function() {
  var $window, Button, Channel, ChannelCollection, ChannelListItem, Collection, ListItem, ListView, MessageListItem, Model, NewMessageForm, StringInput, View, activateChannel, active_channel, active_channel_messages, channel_collection, setUpInterface, withinRange, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
  ...
  MessageListItem = (function(_super) {
    ...
    MessageListItem.prototype.render = function() {
      ...
      this.$el.html("<div class=\"meta\">\n    <span class=\"from\">" + from + "</span><time datetime=\"" + (this.model.get('date')) + "\">" + (_format(this.model.get('date'))) + "</time>\n</div>\n<div class=\"body\">\n    " + (markdown.toHTML(this.model.get('body'))) + "\n</div>");
      return this.el;
    };
